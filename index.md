...
The object and model set was created to facilitate benchmarking of computer vision and robotics applications. You can find the Robotic Grasping Dataset that uses a subset of this object set [**HERE**](https://lachlanchumbley.github.io/XXXXXMonashGraspingDataset/).
